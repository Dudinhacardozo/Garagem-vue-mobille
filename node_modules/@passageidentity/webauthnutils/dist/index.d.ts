...
interface IGetCredentialFeatures {
    /**
     * Browser supports securityKeys which are external keys, such as Yubikeys.
     */
    securityKey: boolean;
    /**
     * Browser supports getting platform credentials created by the user's device, often through biometrics.
     */
    platform: boolean;
    /**
     * Browser supports accessing a cloud-backed up passkey via a service like iCloud or Google Password Manager.
     */
    syncedCredential: boolean;
    /**
     * Browser supports accessing a passkey by cross-device communication, most commonly a QR code
     */
...
declare class GetCredentialUtils {
    ...
    /**
     * Browsers are starting to implement the ability to get client capabilities without needing to parse user agents.
     * Right now only Safari supports this API but browsers like Chrome and Firefox will support it in the future.
     * @return {Promise<IGetCredentialFeatures | undefined>}
     */
    private static _getClientCapabalities;
}
