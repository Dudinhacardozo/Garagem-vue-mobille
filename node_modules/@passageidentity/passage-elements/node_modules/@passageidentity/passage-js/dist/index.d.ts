...
declare enum AuthenticatorAttachment {
    /** Browser will prompt the user to create a passkey locally on the device */
    Platform = "platform",
    /** Browser will prompt the user to create a passkey using an external device like a smartphone or a security key */
    CrossPlatform = "cross-platform",
    /** Browser will give the user the ability to create local or external passkeys */
    Any = "any"
}
...
interface PassageAppInfo {
    ...
    /** @deprecated Check the auth_methods property for the full list of supported authentication methods and their configurations. */
    auth_fallback_method: AllowedFallbackAuth;
    /** @deprecated Check the ttl value in the auth_methods property for the ttl of the SMS OTP or emailed magic link. */
    auth_fallback_method_ttl: number;
    profile_management: boolean;
    passage_branding: boolean;
    element_customization: IElementCustomization;
    element_customization_dark: IElementCustomization;
    auth_methods: {
        passkeys?: Record<string, never>;
        otp?: EmailAndSMSAuthMethod;
        magic_link?: EmailAndSMSAuthMethod;
    };
    social_connections: {
        google?: Record<string, never>;
        github?: Record<string, never>;
        apple?: Record<string, never>;
    };
}
declare enum SocialConnection {
    Google = "google",
    Github = "github",
    Apple = "apple"
}
interface IElementCustomization {
    ...
    passage_header_font_family: WebSafeFonts;
    passage_body_font_family: WebSafeFonts;
...
declare enum WebSafeFonts {
    ANDALE_MONO = "Andal\u00E9 Mono",
    ARIAL = "Arial",
...
interface EmailAndSMSAuthMethod {
    ttl: number;
    ttl_display_unit: 's' | 'm' | 'h' | 'd';
}
declare enum DisplayUnit {
    Seconds = "s",
    Minutes = "m",
    Hours = "h",
    Days = "d"
...
interface PassageUserInfo {
    ...
    webauthn_types: WebAuthnType[];
    social_connections: {
        github?: PassageUserSocialConnection;
        google?: PassageUserSocialConnection;
        apple?: PassageUserSocialConnection;
    };
}
interface PassageUserSocialConnection {
    provider_id: string;
...
declare class User {
     ...
     * @return {Promise<Record<SocialConnection, PassageUserSocialConnection>> } the array of social connections.
     */
     ...
     * @param {PassageUserSocialConnection} socialConnection the PassageUserSocialConnection object representing the connection to be deleted
...
export { AllowedFallbackAuth, AuthenticatorAttachment, BrowserInfo, CaptureEventBody, CreateUserPayload, DisplayUnit, EmailAndSMSAuthMethod, ICaptureEventProps, IElementCustomization, ISentryConfig, Identifier, Metadata, Passage, PassageAppInfo, PassageDevice, PassageEditDeviceRequest, PassageError, PassageErrorCode, PassageMagicLinkRequest, PassageSentryProject, PassageTokenStore, PassageUser, PassageUserInfo, PassageUserSocialConnection, PassageUserStatus, PasskeyCreationOptions, ReadOnlyTokenStore, RequiredIdentifier, Session, SocialConnection, TokenStore, User, UserMetadataLayout, UserMetadataSchema, UserMetadataType, WebAuthnType, WebSafeFonts, WebauthnDeviceIcon, authResult, captureEvent, cleanSentryConfig, isFullTokenStore };
