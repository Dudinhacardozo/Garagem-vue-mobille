...
<html lang="">
    ...
    <body>
        ...
        <script>
            ...
            const beforeAuth = (identifier, payload) => {
                console.log('hit beforeAuth() in index.html, identifier:', identifier);
                console.log('beforeAuth payload:', payload);
                window.payloadTest = payload;
                return true;
            };
