...
import { d as defineComponent, f as ref, af as watchEffect, ag as onUnmounted, _ as _export_sfc, o as openBlock, b as createBlock, e as withCtx, c as createElementBlock, a as createBaseVNode, n as normalizeClass, p as toDisplayString, r as renderSlot, q as withModifiers, z as createCommentVNode, ad as withKeys, O as Transition, h as useLocale, j as computed, V as useAddDevice, P as T, u as unref, ab as resolveComponent, F as InlineSvg, I as Icons, G as useTheme, T as Theme, H, i as usePassage, g as watch, w as withDirectives, x as vModelText, L as Fragment, ah as h, D as createVNode, Z as Dropdown, K as renderList, k as onMounted, y as normalizeStyle, m as createTextVNode, aa as dayjs, ac as oe, a3 as onBeforeUpdate, a4 as useStoreLocale, a5 as useThemeSetup, a6 as useIntlTelInput, a7 as createPassageInstance, N as useDefaultCountryCode } from "./customElements.es.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    function primaryAddDevice() {
      if (supportsPlatform.value === true) {
        onAddDevice(T.Platform);
      } else {
        onAddDevice(T.CrossPlatform);
      }
    }
        ...
        default: withCtx(() => [
          ...
          !unref(errorMessage) ? (openBlock(), createElementBlock("div", _hoisted_6$3, [
            createBaseVNode("button", {
              ...
              "data-testid": "add-device-primary-button"
            }, toDisplayString(supportsPlatform.value ? unref(t)("continue") : unref(t)("use-another-device")), 9, _hoisted_7$2),
            supportsPlatform.value && supportsCrossPlatform.value ? (openBlock(), createElementBlock("button", {
              ...
              "data-testid": "add-device-secondary-button"
            }, toDisplayString(unref(t)("use-another-device")), 9, _hoisted_8$2)) : createCommentVNode("", true)
            ...
            createBaseVNode("button", {
              ...
              style: { "margin-right": "5px", "width": "auto" },
              "data-testid": "add-device-primary-button"
            }, toDisplayString(unref(t)("try-again")), 9, _hoisted_10$1)
          ])),
...
const _sfc_main$7 = defineComponent({
  ...
  setup(__props) {
    ...
    const getDefaultDeviceIcon = (type) => {
      return type === H.SecurityKey ? Icons.securityKey : Icons.passkey;
    };
    const icon = computed(() => {
      var _a, _b;
...
const _hoisted_2$5 = ["readonly", "data-testid"];
        ...
        createBaseVNode("div", _hoisted_1$5, [
          createBaseVNode("div", null, [
            withDirectives(createBaseVNode("input", {
              ...
              tabindex: "0",
              "data-testid": `passkey-table-row-${_ctx.index}-device-name`
...
function useRevokeAuthMethod() {
  ...
  function revokeSocialConnection(socialConnection) {
    return __async(this, null, function* () {
      revokePending.value = true;
      try {
        yield passageUser.deleteSocialConnection(socialConnection);
        return true;
      } catch (e) {
        errorMessage.value = t("failed-to-revoke-this-social-connection");
        return false;
      } finally {
        revokePending.value = false;
      }
      ...
      return showPaginator.value ? (openBlock(), createElementBlock("div", _hoisted_1$4, [
        ...
        createBaseVNode("div", _hoisted_5$2, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(visiblePageButtons.value, (value) => {
            ...
            }, toDisplayString(value + 1), 11, _hoisted_6$2);
          }), 128)),
          createBaseVNode("div", {
...
const _hoisted_2$3 = ["onMousedown", "data-testid"];
...
const _hoisted_4$2 = ["onClick", "data-testid"];
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        showConfirmationButton.value ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
          createBaseVNode("button", {
            ...
            class: "button is-primary",
            part: "button",
            "data-testid": `${confirmationButtonTestID.value}-confirmation`,
          ...
          return openBlock(), createElementBlock("div", {
            ...
            "data-testid": `${action.testID}-${_ctx.index}`
          }, [
            createBaseVNode("div", {
          ...
          createBaseVNode("tbody", null, [
            ...
            page.value ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(page.value, (item, index) => {
              return openBlock(), createElementBlock("tr", {
                ...
                "data-testid": `passkey-table-row-${index}`
              }, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(isMobile.value ? [_ctx.columns[0]] : _ctx.columns, (column, columnIndex) => {
                  return openBlock(), createElementBlock("td", {
                    ...
                    "data-testid": `passkey-table-cell-${columnIndex}`
                  }, [
...
const _sfc_main = defineComponent({
  ...
  setup(__props) {
    ...
    const { t } = useLocale();
    const { passage } = usePassage();
    const { revokeDevice, errorMessage } = useRevokeAuthMethod();
...
function useCurrentUser(appInfo) {
  ...
  function refreshSocialConnections() {
    return __async(this, null, function* () {
      if (!userInfo.value) {
        return;
      }
      try {
        userInfo.value.social_connections = yield passageUser.listSocialConnections();
      } catch (err) {
        error.value = err;
      } finally {
        loading.value = false;
  ...
  function transformMetadata() {
    ...
    appInfo.user_metadata_schema.forEach((schema) => {
      ...
      if (schema.type === oe.DATE && metadataValue) {
...
export { ActionType as A, _sfc_main$5 as _, _sfc_main$1 as a, useCurrentUser as b, _sfc_main as c, useSetupWebauthn as d, useProfileElementSetup as e, useRevokeAuthMethod as u };
//# 
