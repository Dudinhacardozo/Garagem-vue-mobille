...
import { d as defineComponent, h as useLocale, f as ref, _ as _export_sfc, ab as resolveComponent, o as openBlock, c as createElementBlock, a as createBaseVNode, p as toDisplayString, q as withModifiers, z as createCommentVNode, n as normalizeClass, b as createBlock, L as Fragment, j as computed, k as onMounted, l as onBeforeUnmount, r as renderSlot, ad as withKeys, g as watch, D as createVNode, e as withCtx, w as withDirectives, x as vModelText, N as useDefaultCountryCode, t as te, ae as re, G as useTheme, u as unref, F as InlineSvg, T as Theme, I as Icons, J as g, $ as useAppInfo, v as vShow, s as safelyRegisterElement } from "../customElements.es.js";
import { u as useRevokeAuthMethod, _ as _sfc_main$9, a as _sfc_main$a, A as ActionType, b as useCurrentUser, c as _sfc_main$b, d as useSetupWebauthn, e as useProfileElementSetup } from "../customElements.es4.js";
...
const _sfc_main$4 = defineComponent({
  ...
  setup(props) {
    ...
    const showEmail = computed(() => {
      return props.appInfo.allowed_identifier !== te.phone;
    });
    const showPhone = computed(() => {
      return props.appInfo.allowed_identifier !== te.email;
    });
    const emailRequired = computed(() => {
      return props.appInfo.required_identifier === re.Email || props.appInfo.required_identifier === re.Both;
    });
    const phoneRequired = computed(() => {
      return props.appInfo.required_identifier === re.Phone || props.appInfo.required_identifier === re.Both;
    });
    return {
      message,
      globalMessage,
...
const _hoisted_11 = { class: "profile-table-metadata" };
...
const _sfc_main$3 = defineComponent({
  ...
  props: {
    userInfo: {},
    refreshSocialConnections: { type: Function }
  },
  setup(__props) {
    const props = __props;
    const { t } = useLocale();
    ...
    const { revokeSocialConnection, errorMessage } = useRevokeAuthMethod();
    const selectedSocialConnection = ref();
    const dataset = computed(() => {
      ...
      return Object.keys(props.userInfo.social_connections).map((connectionType) => {
        var _a;
        const metadata = socialConnectionMetadata[connectionType];
        return __spreadProps(__spreadValues({}, ((_a = props.userInfo) == null ? void 0 : _a.social_connections)[connectionType]), {
          ...
          icon: theme.value === Theme.Dark ? metadata.icons.dark : metadata.icons.light
        });
      });
    });
    function deleteSocialConnection(socialConnection) {
      return __async(this, null, function* () {
        selectedSocialConnection.value = socialConnection;
        if (errorMessage.value) {
          return true;
        }
        const result = yield revokeSocialConnection(socialConnection.nameKey);
        if (result) {
          actionFinished();
        }
        return result;
    ...
    const tableActions = computed(() => [
      {
        ...
        action: deleteSocialConnection,
        icon: Icons.close,
        alt: "Delete social connection",
        testID: "delete-social-connection-button",
    ...
    function actionFinished() {
      return __async(this, null, function* () {
        selectedSocialConnection.value = void 0;
        refreshing.value = true;
        yield props.refreshSocialConnections();
            ...
            createBaseVNode("div", _hoisted_4$1, [
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_6, [
                  ...
                  unref(errorMessage) ? (openBlock(), createElementBlock("div", _hoisted_10, toDisplayString(unref(errorMessage)), 1)) : createCommentVNode("", true),
                  createBaseVNode("div", _hoisted_11, [
                    createBaseVNode("span", {
                      "data-testid": `passkey-table-row-${index}-device-date-added`
                    }, toDisplayString(`${unref(t)("added-time")}: ${formatDateTime(item.created_at)}`), 9, _hoisted_12),
                    createBaseVNode("span", {
                      "data-testid": `passkey-table-row-${index}-device-last-login`
                    }, toDisplayString(`${unref(t)("last-login")}: ${formatDateTime(item.last_login_at)}`), 9, _hoisted_13)
                  ])
                ])
              ], 2)
            ])
...
const _sfc_main$2 = defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const { userInfo, loading, error, refreshDevices, refreshSocialConnections, refreshMetadata } = useCurrentUser(
      props.appInfo
    );
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        }, null, 8, ["active"])) : unref(error) && unref(error).statusCode !== unref(g).PSGLoginRequired ? (openBlock(), createElementBlock("div", _hoisted_1$1, " Unable to get information about current user: " + toDisplayString(unref(error).statusText), 1)) : createCommentVNode("", true),
        ...
        !unref(loading) && showSocialConnections.value ? (openBlock(), createBlock(_sfc_main$3, {
          key: 6,
          userInfo: unref(userInfo),
          refreshSocialConnections: unref(refreshSocialConnections)
        }, null, 8, ["userInfo", "refreshSocialConnections"])) : createCommentVNode("", true),
