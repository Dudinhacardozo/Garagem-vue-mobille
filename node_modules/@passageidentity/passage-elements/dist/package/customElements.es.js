...
}, m = ((e2) => (e2.Platform = "platform", e2.CrossPlatform = "cross-platform", e2.Any = "any", e2))(m || {});
...
}, T = ((t2) => (t2.Platform = "platform", t2.CrossPlatform = "cross-platform", t2.Any = "any", t2))(T || {}), u = class extends Error {
  constructor(t2, e2) {
    super();
...
var Y = ((o2) => (o2.ACTIVE = "active", o2.INACTIVE = "inactive", o2.PENDING = "pending", o2))(Y || {}), H = ((o2) => (o2.Platform = "platform", o2.Passkey = "passkey", o2.SecurityKey = "security_key", o2))(H || {});
function E(t2) {
...
var te = ((o2) => (o2.email = "email", o2.phone = "phone", o2.both = "both", o2))(te || {}), re = ((s) => (s.Phone = "phone", s.Email = "email", s.Both = "both", s.Either = "either", s))(re || {}), oe = ((a) => (a.STRING = "string", a.BOOLEAN = "boolean", a.INTEGER = "integer", a.DATE = "date", a.PHONE = "phone", a.EMAIL = "email", a))(oe || {}), se = ((o2) => (o2.LoginCode = "otp", o2.MagicLink = "magic_link", o2.None = "none", o2))(se || {}), ne = ((o2) => (o2.Google = "google", o2.Github = "github", o2.Apple = "apple", o2))(ne || {}), ie = ((p2) => (p2.ANDALE_MONO = "Andal\xE9 Mono", p2.ARIAL = "Arial", p2.ARIAL_BLACK = "Arial Black", p2.BASKERVILLE = "Baskerville", p2.BRADLEY_HAND = "Bradley Hand", p2.BRUSH_SCRIPT_MT = "Brush Script MT", p2.COMIC_SANS_MS = "Comic Sans MS", p2.COURIER = "Courier", p2.GEORGIA = "Georgia", p2.GILL_SANS = "Gill Sans", p2.HELVETICA = "Helvetica", p2.IMPACT = "Impact", p2.LUCIDA = "Lucida", p2.LUMINARI = "Luminari", p2.MONACO = "Monaco", p2.PALATINO = "Palatino", p2.TAHOMA = "Tahoma", p2.TIMES_NEW_ROMAN = "Times New Roman", p2.TREBUCHET_MS = "Trebuchet MS", p2.VERDANA = "Verdana", p2))(ie || {}), ae = ((s) => (s.Seconds = "s", s.Minutes = "m", s.Hours = "h", s.Days = "d", s))(ae || {});
/*!
  * shared v9.10.2
...
const baseURL = "https://storage.googleapis.com/passage-frontend/locales/passage-auth";
const localeVersion = "v2";
...
export { useAppInfo as $, pushScopeId as A, popScopeId as B, readonly as C, createVNode as D, u as E, InlineSvg as F, useTheme as G, H, Icons as I, g as J, renderList as K, Fragment as L, isRef as M, useDefaultCountryCode as N, Transition as O, T as P, normalizeProps as Q, guardReactiveProps as R, vModelDynamic as S, Theme as T, UAParser as U, useAddDevice as V, reactive as W, ne as X, Y, Dropdown as Z, _export_sfc as _, createBaseVNode as a, onUpdated as a0, mergeProps as a1, resolveDynamicComponent as a2, onBeforeUpdate as a3, useStoreLocale as a4, useThemeSetup as a5, useIntlTelInput as a6, createPassageInstance as a7, commonjsGlobal as a8, vModelCheckbox as a9, dayjs as aa, resolveComponent as ab, oe as ac, withKeys as ad, re as ae, watchEffect as af, onUnmounted as ag, h as ah, createBlock as b, createElementBlock as c, defineComponent as d, withCtx as e, ref as f, watch as g, useLocale as h, usePassage as i, computed as j, onMounted as k, onBeforeUnmount as l, createTextVNode as m, normalizeClass as n, openBlock as o, toDisplayString$1 as p, withModifiers as q, renderSlot as r, safelyRegisterElement as s, te as t, unref as u, vShow as v, withDirectives as w, vModelText as x, normalizeStyle as y, createCommentVNode as z };
//# 
